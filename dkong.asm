        org 0x0000      ; $3E82 = 05 . For 800 point barrel jump change to 07
...
; $6207         walking, bits 0  and 1 flip around.  jump sets bits 1,2,3 on.  when climbing a ladder,
; $6207         bit 7 flips on and off, and bits 0,1,2 flip around
; $6208 = ?
...
Init                    ; MAIN INITIALIZATION ROUTINE #start
...
;MCOMMENT#### it appears that point scoring was originally coded in this spot and was
;MCOMMENT#### possibly bugged when it was later moved to the end of the program.
...
; patch ?
        ...
        LD      E,$05           ; else set 500 points [bug, should be 800] ___BUG___; should E be $07
